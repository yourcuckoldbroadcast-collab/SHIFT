...
function renderBeranda(){
  ...
  <main class="page">
    ...
    <section class="hero hero--${cls}">
      <svg class="hero__wm" viewBox="0 0 128 120" fill="none" aria-hidden="true"><g fill="currentColor"><rect x="42" y="12" width="7" height="20" rx="3.5" opacity=".5"/><rect x="79" y="12" width="7" height="20" rx="3.5" opacity=".5"/><rect x="22" y="22" width="84" height="86" rx="14" opacity=".10"/><path d="M22 42 V36 a14 14 0 0 1 14-14 h56 a14 14 0 0 1 14 14 v6 Z" opacity=".78"/><g opacity=".4"><circle cx="38" cy="58" r="3.4"/><circle cx="54" cy="58" r="3.4"/><circle cx="74" cy="58" r="3.4"/><circle cx="90" cy="58" r="3.4"/><circle cx="38" cy="76" r="3.4"/><circle cx="90" cy="76" r="3.4"/><circle cx="38" cy="94" r="3.4"/><circle cx="54" cy="94" r="3.4"/><circle cx="74" cy="94" r="3.4"/><circle cx="90" cy="94" r="3.4"/></g><rect x="49" y="69" width="30" height="14" rx="5" opacity=".92"/></g><rect x="22" y="22" width="84" height="86" rx="14" fill="none" stroke="currentColor" stroke-opacity=".42" stroke-width="2.5"/></svg>
